...
namespace QuanLyBanVatLieuXayDung.Presenation
{
    class View
    {
        ...
        static VatLieu_BLL vatLieu_BLL = new VatLieu_BLL();
        static VatLieu_DAL vatLieu_DAL = new VatLieu_DAL();
        ...
        public static void Run()
        {
            ...
            while (true)
            {
                ...
                switch (chon)
                {
                    ...
                    case 2:
                        Console.Clear();
                        VatLieu_GUI.Run(vatLieu_BLL, vatLieu_DAL, xe);
                        Console.WriteLine("                                 Nhập phím bất kì để tiếp tục");
                        Console.ReadLine();
                        Console.Clear();
                        break;
